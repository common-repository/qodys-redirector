...
$redirect_padding = $this->CleanForInput( $this->get_option( 'redirect_padding' ) );
$redirect_detection = $this->CleanForInput( $this->get_option( 'redirect_detection' ) );

$mouse_direction = $this->get_option( 'mouse_direction' );
$redirect_left_margin = $this->CleanForInput( $this->get_option( 'redirect_left_margin' ) );
$redirect_right_margin = $this->CleanForInput( $this->get_option( 'redirect_right_margin' ) );
